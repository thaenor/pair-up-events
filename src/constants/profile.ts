export const PROFILE_COPY = {
  ...
  INVITE_DUO: {
    FIELD_LABEL: 'Shareable link',
    LOADING_LABEL: 'Generating…',
    GENERATE_LABEL: 'Generate link',
    COPY_LABEL: 'Copy link',
    SHARE_LABEL: 'Share invite',
    REVOKE_LABEL: 'Revoke invite',
    STATUS_PENDING: 'Share this link with your duo. Expires {DATE}.',
    STATUS_ACCEPTED: 'Your invite was accepted! 🎉',
    STATUS_EXPIRED: 'This invite expired. Generate a new link.',
    STATUS_NONE: 'Create a link to invite your duo to PairUp.',
  },
  DEVELOPMENT_NOTICE:
...
Let me know what you think! 😊`,
  ...
  INVITE_DUO: {
    ...
    ACCEPT_SUCCESS_MANUAL:
      'Invite accepted! Ask your duo to open PairUp so they can confirm the connection on their side.',
