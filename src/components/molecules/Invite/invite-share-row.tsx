...
export const InviteShareRow: React.FC<InviteShareRowProps> = ({ eventId, isDisabled, inviteMessage }) => {
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white/70 p-4">
      <h4 className="text-sm font-semibold text-pairup-darkBlue flex items-center mb-2">🔗 Invite your duo</h4>
      ...
      <div className="flex flex-col md:flex-row gap-2 md:items-center">
        <input
          ...
          value={inviteLink}
          className={twMerge(
            clsx('w-full rounded-lg border px-3 py-2 text-sm text-pairup-darkBlue bg-gray-50', !eventId && 'opacity-60')
          )}
