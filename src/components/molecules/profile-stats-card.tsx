...
export const ProfileStatsCard: React.FC<ProfileStatsCardProps> = ({ stats }) => {
  ...
  return (
    ...
    >
      <h3 className="text-lg font-semibold text-pairup-darkBlue mb-4">Your PairUp journey</h3>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="rounded-lg border border-pairup-cyan/40 bg-pairup-cyan/10 p-4 text-center">
          <p className="text-sm uppercase tracking-wide text-pairup-darkBlue/70">Events created</p>
          <p className="mt-2 text-3xl font-bold text-pairup-darkBlue" data-testid="profile-stats-created">
            {eventsCreated}
          </p>
        </div>
        <div className="rounded-lg border border-pairup-cyan/40 bg-pairup-cyan/10 p-4 text-center">
          <p className="text-sm uppercase tracking-wide text-pairup-darkBlue/70">Events joined</p>
          <p className="mt-2 text-3xl font-bold text-pairup-darkBlue" data-testid="profile-stats-joined">
            {eventsJoined}
          </p>
        </div>
      </div>
      <p className="mt-4 text-sm text-pairup-darkBlue/70">
        Keep exploring! Your story grows every time you connect with another duo.
      </p>
    </section>
  );
};
