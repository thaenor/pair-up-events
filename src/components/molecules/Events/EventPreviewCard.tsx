      ...
      {(onEdit || onConfirm) && (
        <div className="flex gap-2 mt-3 md:mt-4 pt-3 border-t border-gray-300">
          {onEdit && (
            <button
              onClick={onEdit}
              className="flex-1 px-3 md:px-4 py-3 md:py-2 text-xs md:text-sm font-medium text-pairup-darkBlue bg-white border-2 border-pairup-darkBlue rounded-lg hover:bg-gray-50 transition-colors min-h-11 touch-manipulation"
          ...
          {onConfirm && (
            <div className="flex-1">
              ...
              <button
                onClick={onConfirm}
                className="w-full px-3 md:px-4 py-3 md:py-2 text-xs md:text-sm font-medium text-white bg-pairup-darkBlue rounded-lg hover:bg-opacity-90 transition-colors min-h-11 touch-manipulation"
