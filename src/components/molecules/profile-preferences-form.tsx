  ...
  return (
    ...
    >
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <label htmlFor="profile-fun-fact" className="flex flex-col text-sm font-medium text-pairup-darkBlue/80 md:col-span-2">
          ...
          <textarea
            ...
            aria-label="Fun fact about yourself"
          />
        </label>

        <label htmlFor="profile-likes" className="flex flex-col text-sm font-medium text-pairup-darkBlue/80">
          ...
          <textarea
            ...
            aria-label="Things you like"
          />
        </label>

        <label htmlFor="profile-dislikes" className="flex flex-col text-sm font-medium text-pairup-darkBlue/80">
          ...
          <textarea
            ...
            aria-label="Things you dislike"
          />
        </label>

        <label htmlFor="profile-hobbies" className="flex flex-col text-sm font-medium text-pairup-darkBlue/80 md:col-span-2">
          ...
          <textarea
            ...
            aria-label="Your hobbies and interests"
          />
        </label>
      </div>
