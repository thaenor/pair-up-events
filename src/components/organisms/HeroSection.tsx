...
const HeroSection: React.FC<HeroSectionProps> = ({ onCreateEvent }) => {
    return (
                ...
                <div className="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                            <span className="text-pairup-cyan font-bold">
                                Grab your friend
                            </span>
                            <br />
                            <span className="text-pairup-yellow font-normal">
                    ...
                    <div
                        className="relative h-[400px] md:h-[500px] -mt-40 sm:mt-32 md:mt-0 animate-fade-in flex items-center justify-center"
