    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 md:pt-20">
        <div className="grid md:grid-cols-2 gap-6 items-center">
          <div id="headline-cta" className="animate-fade-in mt-16 sm:mt-64 md:mt-0 [animation-delay:0.2s]">
            <h1 id="hero-heading" className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              ...
              <br />
              <span className="text-pairup-darkBlue font-normal">and meet another pair.</span>
            </h1>
            <p className="text-xl mb-8 text-pairup-darkBlue/90 max-w-lg">
              Some activities are better as a group of 4.
              <br />
              Create your listing and connect with like-minded duos to meet up for shared experiences.
            </p>
          ...
          <div
            id="hero-image"
            className="relative w-full mt-8 sm:mt-10 md:mt-0 animate-fade-in flex items-center justify-center [animation-delay:0.5s]"
          >
