...
const EarlyAccessSection = () => {
  return (
    <section id="early-access" className="py-16 md:py-24 px-4 md:px-8 bg-transparent">
        ...
        <div className="bg-white/30 p-12 rounded-3xl backdrop-blur-sm">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-pairup-darkBlue/80 max-w-2xl mx-auto">
              Be the first to know when we launch. Sign up now to receive exclusive updates, sneak peeks, and priority
