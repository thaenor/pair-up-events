...
const steps = [
  {
    ...
    title: (
      <span>
        <span className="text-pairup-darkblue">Create</span> or <span className="text-pairup-darkblue">Join</span>
      </span>
    ),
...
const HowItWorksSection = () => {
  return (
    <section id="how-it-works" className="py-16 md:py-24 px-4 md:px-8 bg-transparent">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            ...
            >
              ...
              <p className="text-pairup-darkBlue/80">{step.description}</p>
            </div>
          ))}
        </div>
      </div>
