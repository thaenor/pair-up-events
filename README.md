...
9. [Agentic Coding Guidelines (Gemini AI)](#agentic-coding-guidelines-gemini-ai)
...
## Agentic Coding Guidelines (Gemini AI)

> The following is a verbatim copy of `Gemini.md` so that human contributors and automated agents can operate with the same shared understanding.
